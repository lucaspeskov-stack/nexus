    ...
    <section id="avaliacoes" className="relative py-20 md:py-28">
      <div className="container-x">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-5 inline-flex items-center gap-3 rounded-full border border-champagne-300 bg-champagne-50 px-5 py-2.5 shadow-soft">
          ...
          {reviews.map((r, i) => (
            <Reveal key={r.name} delay={i * 60}>
              <figure className="card flex h-full flex-col p-7">
                ...
                <figcaption className="mt-5 flex items-center gap-3 border-t border-champagne-300 pt-4">
                  <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-plum-400 to-plum-600 font-semibold text-champagne-50">
                    {r.name.charAt(0)}
                  </span>
