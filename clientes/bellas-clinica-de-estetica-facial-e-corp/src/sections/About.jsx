...
const pillars = [
  ...
  { icon: HeartHandshake, title: 'Atendimento humano', text: 'Escutamos você para criar o protocolo ideal para a sua pele e o seu corpo.' },
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-2">
        <Reveal>
          <div className="relative mx-auto max-w-lg">
            <div aria-hidden className="absolute -inset-4 -z-10 rounded-[2.5rem] bg-gradient-to-br from-rose-300/40 to-transparent blur-2xl" />
            <SmartImage
              src={gallery[1].src}
        ...
        <div>
          <Reveal>
            ...
            <h2 className="mt-4 font-display text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
              Uma clínica dedicada à sua beleza e ao seu bem-estar
            </h2>
            ...
            <p className="mt-3 leading-relaxed text-stone">
              Na {business.addressShort}, unimos ambiente sereno, protocolos faciais e corporais
              personalizados e produtos de qualidade para tornar a sua experiência de estética
            ...
            {pillars.map((p, i) => (
              <Reveal key={p.title} delay={i * 60}>
                <div className="flex gap-3 rounded-2xl border border-cream-300 bg-cream-50/80 p-4 shadow-soft">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-cream-200 text-rose-600">
