...
export default function MapSection() {
  const embed =
    ...
    encodeURIComponent('Bellas Clínica de Estética Facial e Corporal, Rua Conde de Bonfim, 370, Tijuca, Rio de Janeiro') +
    '&output=embed';
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-rose-700 hover:text-rose-600"
                    >
