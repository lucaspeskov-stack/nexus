      ...
      <div className="container-x">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 font-display text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
            Nota máxima entre nossas clientes
          </h2>
          ...
          {reviews.map((r, i) => (
            <Reveal key={r.name} delay={i * 60}>
              <figure className="card flex h-full flex-col p-7">
                <Quote size={28} className="text-bronze-500" />
                ...
                <figcaption className="mt-5 flex items-center gap-3 border-t border-cream-300 pt-4">
                  <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-rose-400 to-rose-600 font-semibold text-cream-50">
                    {r.name.charAt(0)}
                  </span>
