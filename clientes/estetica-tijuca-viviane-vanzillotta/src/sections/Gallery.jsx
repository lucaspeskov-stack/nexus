...
/**
 * Galeria com as 5 fotos oficiais (Google Maps / Street View). Layout mosaico
 * editorial; como as fotos são landscape, a primeira ocupa destaque em largura.
 */
      ...
      <div className="container-x">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-stone">
            A atmosfera acolhedora da {business.shortName}, na {business.neighborhood}.
          </p>
        </Reveal>
        ...
        <p className="mt-6 text-center text-xs text-stone/70">
          Imagens oficiais do estabelecimento (Google Maps / Street View).
        </p>
      </div>
    </section>
  );
