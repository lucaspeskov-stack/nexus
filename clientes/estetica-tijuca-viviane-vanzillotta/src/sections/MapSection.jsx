...
export default function MapSection() {
  const embed =
    ...
    encodeURIComponent('Estetica Tijuca Viviane Vanzillotta, Rua Conde de Bonfim, 346, Tijuca, Rio de Janeiro') +
    '&output=embed';
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-sage-700 hover:text-sage-600"
                    >
