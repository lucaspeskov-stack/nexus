    ...
    <div className={`relative overflow-hidden bg-cream-300 ${className}`}>
      {!failed ? (
        ...
        <div
          role="img"
          aria-label={alt}
          className="flex h-full w-full items-center justify-center bg-gradient-to-br from-cream-300 via-teal-400 to-teal-600"
        >
          <span className="font-display text-3xl font-semibold text-cream-50/90">MBN</span>
        </div>
      )}
    </div>
  );
