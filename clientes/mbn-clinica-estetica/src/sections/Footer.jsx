      ...
      <div className="container-x grid gap-10 py-14 md:grid-cols-3">
        <div>
          <div className="flex items-center gap-2.5">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-teal-500 font-display text-sm font-bold text-cream-50">
              MBN
            </span>
            <span className="font-display text-lg font-semibold tracking-tight text-cream-50">
              MBN <span className="font-normal text-gold-400">Estética</span>
            </span>
          </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5">
            {links.map((l) => (
              <li key={l.href}>
                <a href={l.href} className="text-sm text-cream-100/70 transition-colors hover:text-gold-400">
                  {l.label}
                </a>
              </li>
            ))}
