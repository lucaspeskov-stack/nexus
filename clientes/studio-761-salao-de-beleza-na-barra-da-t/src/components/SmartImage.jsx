    ...
    <div className={`relative overflow-hidden bg-cream-300 ${className}`}>
      {!failed ? (
        ...
        <div
          role="img"
          aria-label={alt}
          className="flex h-full w-full items-center justify-center bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-700"
        >
          <span className="font-display text-4xl font-semibold text-cream-50/90">761</span>
        </div>
      )}
    </div>
  );
