      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-2">
        <Reveal>
          <div className="relative mx-auto max-w-lg">
            <div aria-hidden className="absolute -inset-4 -z-10 rounded-[2.5rem] bg-gradient-to-br from-emerald-300/40 to-transparent blur-2xl" />
            <SmartImage
              src={gallery[1].src}
        ...
        <div>
          <Reveal>
            ...
            <h2 className="mt-4 font-display text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
              Um salão de referência na Barra da Tijuca
            </h2>
