              ...
              {channels.map((c, i) => (
                <Reveal key={c.label} delay={i * 60}>
                  <a
                    ...
                    className="group flex items-center gap-4 rounded-2xl border border-cream-300 bg-cream-50/80 p-4 shadow-soft transition-all hover:-translate-y-0.5 hover:border-emerald-400 hover:shadow-soft-lg"
                  >
                    <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-cream-200 text-emerald-600 transition-colors group-hover:bg-emerald-500 group-hover:text-cream-50">
                      <c.icon size={22} />
                    </span>
              ...
              <div className="mt-6 space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-cream-300 bg-cream-50 px-4 py-3 text-sm text-ink outline-none transition-colors placeholder:text-stone/60 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/15"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-cream-300 bg-cream-50 px-4 py-3 text-sm text-ink outline-none transition-colors focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/15"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full resize-none rounded-xl border border-cream-300 bg-cream-50 px-4 py-3 text-sm text-ink outline-none transition-colors placeholder:text-stone/60 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/15"
                  />
                </div>
