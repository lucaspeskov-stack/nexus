      ...
      <div className="container-x grid gap-10 py-14 md:grid-cols-3">
        <div>
          <div className="flex items-center gap-2.5">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500 font-display text-sm font-bold text-brass-400">
              761
            </span>
            <span className="font-display text-lg font-semibold tracking-tight text-cream-50">
              Studio <span className="font-normal text-brass-400">761</span>
            </span>
          </div>
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-cream-100/70">
            {business.tagline}. Um salão de beleza na {business.neighborhood}, {business.city}.
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5">
            {links.map((l) => (
              <li key={l.href}>
                <a href={l.href} className="text-sm text-cream-100/70 transition-colors hover:text-brass-400">
                  {l.label}
                </a>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-cream-100/70">
            <li className="flex items-start gap-2.5">
              ...
              <a href={business.maps} target="_blank" rel="noopener noreferrer" className="hover:text-brass-400">
                {business.address}
              </a>
            </li>
            <li className="flex items-center gap-2.5">
              <MessageCircle size={17} className="shrink-0 text-brass-400" />
              <a href={business.whatsapp} target="_blank" rel="noopener noreferrer" className="hover:text-brass-400">
                {business.phoneDisplay}
              </a>
            </li>
            <li className="flex items-center gap-2.5">
              <Instagram size={17} className="shrink-0 text-brass-400" />
              <a href={business.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-brass-400">
