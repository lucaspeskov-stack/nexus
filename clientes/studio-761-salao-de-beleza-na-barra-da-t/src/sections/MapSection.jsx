...
export default function MapSection() {
  const embed =
    ...
    encodeURIComponent('Studio 761, Av. das Américas, 10501, Barra da Tijuca, Rio de Janeiro') +
    '&output=embed';
      ...
      <div className="container-x">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 font-display text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
            Na Barra da Tijuca, fácil de chegar
          </h2>
            ...
            <Reveal>
              <div className="card p-6">
                <div className="flex items-start gap-3">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-cream-200 text-emerald-600">
                    <MapPin size={20} />
                  </span>
                  <div>
                    ...
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-emerald-600 hover:text-emerald-500"
                    >
