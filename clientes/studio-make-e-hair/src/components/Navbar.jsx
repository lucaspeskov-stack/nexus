      ...
      <nav className="container-x flex h-16 items-center justify-between md:h-20">
        <a href="#top" className="flex items-center gap-2.5" aria-label={`${business.name} — início`}>
          ...
          <span className="font-display text-base font-semibold tracking-tight text-ink sm:text-lg">
            Studio <span className="font-normal text-wine-600">Make e Hair</span>
          </span>
        </a>
        ...
        <div className="hidden items-center gap-1 lg:flex">
          {links.map((l) => (
            <a
              key={l.href}
              href={l.href}
              className="rounded-full px-4 py-2 text-sm font-medium text-stone transition-colors hover:bg-cream-50 hover:text-wine-600"
            >
              {l.label}
            </a>
          ))}
        ...
        <button
          ...
          aria-expanded={open}
          className="flex h-11 w-11 items-center justify-center rounded-xl border border-wine-500/30 bg-cream-50/80 text-wine-600 lg:hidden"
        >
          ...
          <div className="container-x flex flex-col gap-1 py-4">
            {links.map((l) => (
              <a
                ...
                className="rounded-xl px-4 py-3 text-base font-medium text-ink hover:bg-cream-50 hover:text-wine-600"
              >
                {l.label}
              </a>
            ))}
            <a
              ...
              className="mt-1 inline-flex items-center gap-2 rounded-xl px-4 py-3 text-sm text-wine-600"
            >
