...
const pillars = [
  ...
  { icon: Sparkles, title: 'Make & Hair', text: 'Maquiagem e cabelo no mesmo lugar, com harmonia e técnica.' },
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-2">
        <Reveal>
          <div className="relative mx-auto max-w-lg">
            <div aria-hidden className="absolute -inset-4 -z-10 rounded-[2.5rem] bg-gradient-to-br from-rose-300/50 to-transparent blur-2xl" />
            <SmartImage
              src={gallery[1].src}
        ...
        <div>
          <Reveal>
            ...
            <p className="mt-4 text-lg leading-relaxed text-stone">
              O {business.name} une maquiagem e cabelo em uma experiência de cuidado e acolhimento.
            ...
            {pillars.map((p, i) => (
              <Reveal key={p.title} delay={i * 60}>
                <div className="flex gap-3 rounded-2xl border border-cream-300 bg-cream-50/80 p-4 shadow-soft">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-cream-200 text-wine-600">
