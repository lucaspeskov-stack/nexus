...
export default function MapSection() {
  const embed =
    ...
    encodeURIComponent('Studio Make e Hair, Rua Conde de Lages, 44, Centro, Rio de Janeiro') +
    '&output=embed';
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-wine-600 hover:text-wine-500"
                    >
