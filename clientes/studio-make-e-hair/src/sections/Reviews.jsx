          ...
          {reviews.map((r, i) => (
            <Reveal key={r.name} delay={i * 60}>
              <figure className="card flex h-full flex-col p-7">
                <Quote size={28} className="text-rose-400" />
                ...
                <figcaption className="mt-5 flex items-center gap-3 border-t border-cream-300 pt-4">
                  <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-wine-400 to-wine-600 font-semibold text-cream-50">
                    {r.name.charAt(0)}
                  </span>
