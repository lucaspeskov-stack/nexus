# Studio Sol Cruz Hair & Makeup — Site

Site institucional premium do **Studio Sol Cruz Hair & Makeup** (Copacabana, Rio de Janeiro),
...
- **Paleta Sol/dourado quente** (escolhida como base): `#FBF4E9` (creme) · `#2A211A` (texto) · `#C96F3C` (terracota/sol) · `#B8893C` (dourado).
- **Tipografia:** Playfair Display (títulos) + Inter (texto).
- **Contraste:** texto marrom-escuro sobre creme e texto claro sobre scrim escuro no Hero — mínimo AA.
...
- **Contato:** o número informado é um **WhatsApp** (`+55 21 97470-9833`); a CTA principal abre o
  WhatsApp com mensagem pré-preenchida. Não foi informado um Instagram — o campo "Instagram" do
  briefing era, na verdade, o link de WhatsApp.
