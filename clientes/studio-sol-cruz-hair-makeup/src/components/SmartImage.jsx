    ...
    <div className={`relative overflow-hidden bg-cream-300 ${className}`}>
      {!failed ? (
        ...
        <div
          role="img"
          aria-label={alt}
          className="flex h-full w-full items-center justify-center bg-gradient-to-br from-cream-300 via-sun-300 to-sun-500"
        >
          <span className="font-display text-3xl font-semibold text-cream-50/90">Sol Cruz</span>
        </div>
      )}
    </div>
  );
