...
export default function MapSection() {
  const embed =
    ...
    encodeURIComponent('Studio Sol Cruz Hair & Makeup, Av. Nossa Sra. de Copacabana, 613, Rio de Janeiro') +
    '&output=embed';
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-sun-700 hover:text-sun-600"
                    >
